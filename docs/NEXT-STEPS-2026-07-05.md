...
> **⚠ 2026-07-06 战略重排（读我）**：Eddie 确认网站的首要任务不是 SEO 获客，而是
> **信任验证**——大单来自设计师/经纪/老客户介绍，被介绍的客户会搜公司名、看网站，
> 30 秒内决定"这家店是否靠谱、专业、做过大活"。所有任务按此重排：
>
> **T0 信任层（最优先）**：① /gallery 作品集（已重建 2026-07-06：电影级开场视频 +
> 精选项目编辑排版 + 竖屏视频轮播 + 瀑布流照片墙/分类筛选 + 信任条 + 转介绍 CTA，
> 全部移动端适配）——素材是燃料：Eddie 持续在后台传项目视频/安装实拍图，量越大越可信；
> ② 首页 hero poster + 项目版块指向新 gallery；③ About 页的传承故事 + 团队/车间实拍；
> ④ 评价上屏（商品页 + gallery 底部拉 2-3 条五星）；⑤ Google Business Profile 的照片
> 和评分与网站互相呼应（站外但同权重）。
> **T1 转化层**：Apple Pay、配置器可视化色卡、交期展示、AI 客服兜底交互。
> **T2 运营层**：告警邮件、每日摘要、发货一键化、邀评自动化。
> **T3 增长层**：SEO 内容（how-to-measure/faq 充实）、分类导航、分期付款。
> 原 Phase A（Stripe 切正式/开店）不变——那是营业前提，与信任层并行推进。
