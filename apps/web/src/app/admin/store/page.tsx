    ...
    <div className="min-h-screen">
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="px-8 py-6">
          ...
          <p className="text-sm text-gray-400 mt-0.5">Orders, products and e-commerce settings</p>
        </div>
      </div>
      ...
      <div className="px-8 py-8">
        ...
        {/* ── Store Features ── */}
        <div className="mb-10">
          <h2 className="text-xs font-medium text-gray-400 uppercase tracking-widest mb-4">Store Features</h2>
        ...
        <div className="mb-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              ...
              { href: '/admin/discount-codes', label: 'Discounts',    desc: 'Create and manage promo codes' },
            ].map(item => (
