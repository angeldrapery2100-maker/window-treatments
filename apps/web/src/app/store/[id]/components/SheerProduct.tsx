            ...
            <div className="grid md:grid-cols-2 gap-12 mt-4">
              ...
              <div>
                <div className="flex items-center gap-2 text-xs text-gray-400 tracking-wide uppercase mb-4">
                  ...
                  <span>›</span>
                  <span className="text-gray-600">{productName || 'Sheer Curtain'}</span>
                </div>
                <h1 className="text-2xl font-light tracking-wide text-gray-900 mb-1">{productName || 'Sheer Curtain'}</h1>
                ...
                <div className="space-y-4">
                  ...
                  <div className="py-2 space-y-1 min-h-[48px]">
                    {isCalculating ? (
                      ...
                      <p className="text-sm text-red-400 text-xs">{calcError}</p>
                    ) : unitPrice > 0 ? (
                      <>
