...
const IMG_BASE = '/hunter-douglas/duette'
...
function PowerViewOperatingRowSection({ title, items, onImg }: { title: string; items: ImageLabel[]; onImg: (s: string) => void }) {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.8fr_0.66fr_0.66fr] gap-4 items-stretch">
        <div className="md:col-span-1 h-full flex flex-col md:py-2">
          {powerView && (
            <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2 md:max-w-[45%] md:mx-auto" onClick={() => onImg(`${IMG_BASE}/${powerView.image}`)}>
              <img
        ...
        {sideItems.map((item) => (
          <div key={item.label} className="h-full flex flex-col">
            <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${item.image}`)}>
              <img
...
function DuetteOperatingSystemsSection({ items, onImg }: { items: ImageLabel[]; onImg: (s: string) => void }) {
  const find = (key: string) => items.find((it) => it.label.toLowerCase().includes(key.toLowerCase()))
    ...
    <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {vertiglideMain && (
            <div className="md:col-span-1">
              <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${vertiglideMain.image}`)}>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
          ...
          {powerViewShapes && (
            <div className="md:col-span-1">
              <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${powerViewShapes.image}`)}>
          ...
          <div className="space-y-6">
            {skyLift && (
              <div>
                <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${skyLift.image}`)}>
            ...
            {simplicitySkylight && (
              <div>
                <div className="rounded-md overflow-hidden bg-gray-100 cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${simplicitySkylight.image}`)}>
...
function DuetteMountingProfilesSection({ items, onImg }: { items: ImageLabel[]; onImg: (s: string) => void }) {
  const find = (key: string) => items.find((it) => it.label.toLowerCase().includes(key.toLowerCase()))
  const topGrid = [
    ...
    <div className="space-y-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        <div className="md:col-span-2 grid grid-cols-2 gap-6">
          {topGrid.map((item, i) => (
            <div key={i}>
              <div className="rounded-md overflow-hidden bg-[#a3a8a4] cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${item.image}`)}>
                <img src={`${IMG_BASE}/${item.image}`} alt={item.label} className="w-full h-auto" loading="lazy" />
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {partial125 && (
          <div>
            <div className="rounded-md overflow-hidden bg-[#a3a8a4] cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${partial125.image}`)}>
        ...
        <div className="md:col-span-2 space-y-4">
          {valance1 && (
            <div>
              <div className="rounded-md overflow-hidden bg-[#a3a8a4] cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${valance1.image}`)}>
          ...
          {valance2 && (
            <div>
              <div className="rounded-md overflow-hidden bg-[#a3a8a4] cursor-zoom-in mb-2" onClick={() => onImg(`${IMG_BASE}/${valance2.image}`)}>
...
function AdditionalOperatingOptionsSection({ title, items, onImg }: { title: string; items: ImageLabel[]; onImg: (s: string) => void }) {
  const find = (key: string) => items.find((it) => it.label.toLowerCase().includes(key.toLowerCase()))
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {scenes.map((scene, i) => (
        <div key={i} className={`group rounded-lg overflow-hidden bg-[#e5e7e2] cursor-zoom-in relative ${i === 0 ? 'md:col-span-2' : ''}`}
          ...
          <div className={`w-full ${i === 0 ? 'aspect-[16/9]' : 'aspect-[4/3]'}`}>
            <img
